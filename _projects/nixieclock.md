...
The time is maintained by an RTC with battery backup (CR2032 coin cell). There is a parser that allows the time, date, and format to be set through UART commands. 
